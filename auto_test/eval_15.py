    ...
    for required in required_items:
        for item in cart_items:
            if isinstance(item, dict):
                ...
                if ('iPhone 15' in product_name or 'iPhone15' in product_name) and \
                   required['color'] == item_color and \
                   required['storage'] == item_storage and \
                   item_quantity >= required['quantity']:
