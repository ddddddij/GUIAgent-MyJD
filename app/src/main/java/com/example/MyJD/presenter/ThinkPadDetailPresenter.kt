...
class ThinkPadDetailPresenter(
    private val repository: DataRepository
) : ThinkPadDetailContract.Presenter {
    
    private var view: ThinkPadDetailContract.View? = null
    ...
    override fun attachView(view: ThinkPadDetailContract.View) {
        this.view = view
    }
        ...
        presenterScope.launch {
            try {
                val productDetail = withContext(Dispatchers.IO) {
                    repository.getThinkPadProductDetail(productId)
                }
