...
class SearchResultPresenter(
    ...
    override fun sortProducts(sortType: SearchSortType) {
        ...
        view?.updateSortType(
            when (sortType) {
                SearchSortType.COMPREHENSIVE -> com.example.MyJD.domain.model.ProductSortType.DEFAULT
                SearchSortType.SALES -> com.example.MyJD.domain.model.ProductSortType.SALES_DESC
                SearchSortType.PRICE_ASC -> com.example.MyJD.domain.model.ProductSortType.PRICE_LOW_TO_HIGH
                SearchSortType.PRICE_DESC -> com.example.MyJD.domain.model.ProductSortType.PRICE_HIGH_TO_LOW
            }
        )
        applyCurrentSortAndFilter()
    }
