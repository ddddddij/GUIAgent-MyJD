...
import com.example.MyJD.presentation.ui.components.*
import com.example.MyJD.viewmodel.HuaweiMate60DetailViewModel
import com.example.MyJD.viewmodel.HuaweiMate60DetailViewModelFactory

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun HuaweiMate60DetailScreen(
    productId: String,
    onBackClick: () -> Unit,
    onCartClick: () -> Unit,
    ...
    val viewModel: HuaweiMate60DetailViewModel = viewModel(
        factory = HuaweiMate60DetailViewModelFactory(repository, context)
    )
